...
public class isMoveTEST {
    ...
    public isMoveTEST(int[] input1, boolean expected){  
        this.input1 = input1;   
   ...
   @Test  
    public void testAdd(){  
        ...
        assertEquals(expected, p.isMoveDown(input1));   
        assertEquals(expected, p.isMoveUp(input1));  
        assertEquals(expected, p.isMoveRight(input1));  
        assertEquals(expected, p.isMoveLeft(input1));  
